...
public abstract class PipelineFactory {
     ...
     */
    public PipelineNode buildPipeline(Recipe[] recipes, String targetItem, float targetOutputPerMin){
     ...
     * @return the root pipeline node for the resulting pipeline
     */
    public PipelineNode buildPipeline(Recipe[] recipes, String targetItem, String limitingInputItem, float limitingItemInputPerMin){
        throw new MethodNotImplementedException();
    }
}
